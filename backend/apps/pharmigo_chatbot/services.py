    ...
    def _build_request_brief(
        ...
        *,
        ...
        return (
            ...
            "- Si un pharmacien ou un admin demande un rapport, utilisez d'abord les faits internes calculés avant de proposer une reformulation plus professionnelle.\n"
            "- Si une période par défaut a été utilisée dans les faits internes, signalez-la explicitement et laissez la porte ouverte à un autre intervalle.\n"
