...
PHARMIGO_OMNI_REWARD_ENABLED = _read_bool_env("PHARMIGO_OMNI_REWARD_ENABLED", default=True)
PHARMIGO_REFERRAL_THRESHOLD = int(os.getenv("PHARMIGO_REFERRAL_THRESHOLD", "20") or "20")
PHARMIGO_REFERRAL_MIN_ACTIVITY = int(os.getenv("PHARMIGO_REFERRAL_MIN_ACTIVITY", "10") or "10")
PHARMIGO_REFERRAL_DEVICE_DAILY_LIMIT = int(os.getenv("PHARMIGO_REFERRAL_DEVICE_DAILY_LIMIT", "3") or "3")
PHARMIGO_REFERRAL_BONUS_DAYS = int(os.getenv("PHARMIGO_REFERRAL_BONUS_DAYS", "90") or "90")
